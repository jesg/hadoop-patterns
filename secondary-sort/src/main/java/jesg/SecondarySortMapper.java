...
class SecondarySortMapper extends
        Mapper<LongWritable, Text, AvroKey<SecondarySortKey>, LongWritable> {
    ...
    public void map(LongWritable key, Text value, Context context)
        ...
        context.write(new AvroKey<SecondarySortKey>(secondarySortKey),
                new LongWritable(Long.valueOf(data[2])));
    }
}
