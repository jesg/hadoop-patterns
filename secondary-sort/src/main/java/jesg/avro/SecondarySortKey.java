...
public class SecondarySortKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SecondarySortKey\",\"namespace\":\"jesg.avro\",\"doc\":\"Special key that sorts first by station then by timestamp.\",\"fields\":[{\"name\":\"station\",\"type\":\"long\"},{\"name\":\"timestamp\",\"type\":\"long\",\"order\":\"descending\"}]}");
  ...
  /** Creates a new SecondarySortKey RecordBuilder by copying an existing Builder */
  public static jesg.avro.SecondarySortKey.Builder newBuilder(jesg.avro.SecondarySortKey.Builder other) {
    return new jesg.avro.SecondarySortKey.Builder(other);
  }
  
  /** Creates a new SecondarySortKey RecordBuilder by copying an existing SecondarySortKey instance */
  public static jesg.avro.SecondarySortKey.Builder newBuilder(jesg.avro.SecondarySortKey other) {
    return new jesg.avro.SecondarySortKey.Builder(other);
  }
   ...
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SecondarySortKey>
